...
const TECH_FEEDS: Record<string, Feed[]> = {
  ...
  outages: [
    ...
    { name: 'Cloud Outages', url: rss('https://news.google.com/rss/search?q=(Azure+OR+GCP+OR+Cloudflare+OR+Slack+OR+GitLab)+outage+OR+down+when:1d&hl=en-US&gl=US&ceid=US:en') },
  ],
  security: [
...
export const SOURCE_REGION_MAP: Record<string, { labelKey: string; feedKeys: string[] }> = {
  ...
  developer: { labelKey: 'header.sourceRegionDeveloper', feedKeys: ['cloud', 'dev', 'producthunt', 'outages'] },
